...
public class RegisterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_userAccount = findViewById(R.id.ed_register_account);
        reg_userPwd = findViewById(R.id.ed_register_pwd);
        reg_confirm_userPwd = findViewById(R.id.ed_register_confirm_pwd);
